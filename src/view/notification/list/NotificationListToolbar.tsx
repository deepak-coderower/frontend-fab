...
const NotificationToolbar = (props) => {
  ...
  const hasPermissionToCreate = useSelector(
    notificationSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    notificationSelectors.selectPermissionToImport,
  );
  ...
  return (
    <ToolbarWrapper>
      ...
      {hasPermissionToAuditLogs && (
        <Button
          component={Link}
          to="/audit-logs?entityNames=notification"
